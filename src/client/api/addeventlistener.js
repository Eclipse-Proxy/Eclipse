		...
		if (["message", "messageerror"].includes(type)) {
			const wrappedFunc = function (event) {
				Object.defineProperty(event, "origin", {
					value: new URL(__eclipse$rewrite.url.decode(window.location.href))
						.origin,
				});
			...
			const wrappedFunc = function (event) {
				Object.defineProperty(event, "newURL", {
					value: __eclipse$rewrite.url.decode(event.newURL),
				});
				Object.defineProperty(event, "oldURL", {
					value: __eclipse$rewrite.url.decode(event.oldURL),
				});
