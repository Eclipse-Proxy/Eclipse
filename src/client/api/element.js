...
let originalElementInnerHTML = Object.getOwnPropertyDescriptor(Element.prototype, "innerHTML");
Object.defineProperty(Element.prototype, "innerHTML", {
    set(value) {
        if (this instanceof HTMLScriptElement) {
            originalElementInnerHTML.set.call(this, __eclipse$rewrite.javascript(value, window.location.href));
        } else if (this instanceof HTMLStyleElement) {
            originalElementInnerHTML.set.call(this, __eclipse$rewrite.css(value, window.location.href));
        } else {
            originalElementInnerHTML.set.call(this, __eclipse$rewrite.html(value, window.location.href, true));
        }
...
let originalElementInnerText = Object.getOwnPropertyDescriptor(Element.prototype, "innerText");
Object.defineProperty(Element.prototype, "innerText", {
    set(value) {
        if (this instanceof HTMLScriptElement) {
            originalElementInnerText.set.call(this, __eclipse$rewrite.javascript(value, window.location.href));
        } else if (this instanceof HTMLStyleElement) {
            originalElementInnerText.set.call(this, __eclipse$rewrite.css(value, window.location.href));
        } else {
...
Object.defineProperty(Element.prototype, "setAttribute", {
    value: function (name, value) {
        if (urlAttributes.has(name)) {
            originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
            return originalElementSetAttribute.call(this, name, value ? __eclipse$rewrite.url.encode(value, window.location.href) : "");
        } else if (deleteAttributes.has(name)) {
            return originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
        } else if (srcSetAttributes.has(name)) {
            originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
            return originalElementSetAttribute.call(this, name, value ? __eclipse$rewrite.srcset(value, window.location.href, true) : "");
        } else if (htmlAttributes.has(name)) {
            originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
            return originalElementSetAttribute.call(this, name, value ? __eclipse$rewrite.html(value, window.location.href) : "");
        } else if (cssAttributes.has(name)) {
            originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
            return originalElementSetAttribute.call(this, name, value ? __eclipse$rewrite.css(value, window.location.href) : "");
        } else if (javascriptAttributes.has(name)) {
            originalElementSetAttribute.call(this, `data-eclipse-attr-${name}`, value);
            return originalElementSetAttribute.call(this, name, value ? __eclipse$rewrite.javascript(value, window.location.href) : "");
        } else {
...
let originalContentWindow = Object.getOwnPropertyDescriptor(HTMLIFrameElement.prototype, "contentWindow").get;
...
let originalContentDocument = Object.getOwnPropertyDescriptor(HTMLIFrameElement.prototype, "contentDocument").get;
